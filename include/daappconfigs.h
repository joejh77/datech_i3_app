...
#ifdef DEF_MMB_VER_2	// MMB test
#define RECORDING_DURATION_SECS	(1*60) 

#define PRE_RECORDING_SECONDS	5
#define POST_RECORDING_SECONDS	5
#else
...
#ifdef SOS_CHECK
#define SAFETY_START_RECORDING_SECONDS	(15 * 1000)	//booting time test
#else
